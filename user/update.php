...
<style type="text/css">
    ...
    <main class="bg-light p-3 pt-5" style="min-height:100vh">
      <form class="container-fluid" method="post" action="" enctype="multipart/form-data">
				<input class="form-control form-control-lg" type="hidden" placeholder="Judul" name="id" value="<?=$recipe['id'] ?>">
				<div class="d-flex gap-2 justify-content-between" style="align-items: center;">
					<h2>Edit Resep</h2>
					<button type="submit" name="submit" class="btn btn-outline-primary btn-sm">Simpan Perubahan</button>     
				</div>
				<div class="row mt-4">

					<div class="col-9">
						<div class="">
							<input class="form-control form-control-lg" type="text" placeholder="Judul" name="title" value="<?=$recipe['title'] ?>">
						</div>
						<div class="mt-5">
					...
					<div class="col-3 px-2">
						<div class="d-flex justify-content-end align-items-center">
							<div class="position-relative" style="width: 400px; height: 400px">
								<img width="400px" height="400px" src="../assets/img/<?=$thumbnail?>" class="img-preview" style="object-fit: cover;"/>
